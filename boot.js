...
const els = {
  ...
  moonPhaseBtn: document.getElementById("moonPhaseBtn"),
  moonPhasePanel: document.getElementById("moonPhasePanel"),
  moonPhaseHost: document.getElementById("moonPhaseHost"),
